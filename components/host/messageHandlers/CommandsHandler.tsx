/**
 * CommandsHandler Component
 * Manages commands CRUD operations
...
interface CommandsHandlerProps {
  commands: Command[];
...
export const CommandsHandler: React.FC<CommandsHandlerProps> = memo(({
  commands,
  setCommands,
  onCreateCommand,
  onRenameCommand,
...
CommandsHandler.displayName = 'CommandsHandler';
